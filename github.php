...
if (isset($_SERVER[$header]) && $_SERVER[$header] === $hash) {
    ...
    if (isset($payload_decoded['ref']) && $payload_decoded['ref'] === 'refs/heads/main') {
        shell_exec('cd /var/www/html && git reset --hard HEAD && git fetch origin main && git pull origin main 2>&1');
    }
}
